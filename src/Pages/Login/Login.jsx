    ...
    const emailLogin= async ()=>{
      if(email && password){
        ...
        try {
          setMessage("Loading...");
          setMessageType("info");
          const response = await axios.post("https://theslugproject.onrender.com/login",{
            email:email,
            password:password,
          },
          {
...
function handleSubmit(e) {
  e.preventDefault(); 
    ...
    return(
        ...
        <div className='w-full h-screen flex flex-col items-center justify-center  font-poppins' style={{backgroundImage: "url('src/assets/image/Splines.png')"}}>
            <div className='w-2/4 h-3/5'>
              
            <div className="card w-full bg-[#fff] shadow-xl  shadow-slate-100/10 overflow-hidden ">
<svg className="img" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve"  version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 784.37 1277.39" xmlnsXlink="http://www.w3.org/1999/xlink">
 <g id="Layer_x0020_1">
  ...
  <div className="textBox w-full ">
   ...
   <div className="w-full flex flex-col items-center mt-10 border-b-[1px]">
    <img className='w-28' src="src/assets/image/slugblack.png" alt="" />
    <p className='text-center text-lg font-medium text-black'>Sign in to Slug</p>
   </div>
    <div className='w-full h-80 flex flex-col items-center gap-4 pt-10 bg-[#f9fafb]'>
      <div className='flex flex-col w-2/5 gap-3 text-[#6c757d]'>
      ...
      <form onSubmit={handleSubmit} action="" className='flex flex-col gap-4'>
        ...
        <button type={type} onClick={(e) => { change(e.type) }} className=' w-full appbtn text-[#3e5c76] bg-[#fff] h-10 px-3'>Continue with Email</button>
      </form>
